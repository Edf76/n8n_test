...
#Vuelve al usuario *node*, recomendado para ejecutar la aplicación de forma segura USER node
# Declara /data como un volumen persistente
# Esto permite conservar la información do n8n (flujos, credenciales, etc.) fuera del contenedor 
VOLUME /data
